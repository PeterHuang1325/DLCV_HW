...
def read_options():
    ...
    parser.add_argument(
        '-m', '--model_type', type=str, default='DCGAN',
        help='Model for training GAN'
    )
    parser.add_argument(
        '-lr_D', '--lr_D', type=float, default=2e-4,
        help='Learning rate for discriminator'
    )
    parser.add_argument(
        '-lr_G', '--lr_G', type=float, default=2e-4,
    ...
    parser.add_argument(
        '-zdim', '--z_dim', type=int, default=100,
        help='z dim for training'
    )
    parser.add_argument(
        '-critc', '--n_critic', type=int, default=1,
    ...
    parser.add_argument(
        '-clp', '--clip_value', type=float, default=0.01,
        help='weight clipping for WGAN'
    )
    parser.add_argument(
        '-svp', '--save_path', type=str, default='./gan_results/',
        help='Save path for GAN training checkpoints'
    )
    parser.add_argument(
        '-wdir', '--workspace_dir', type=str, default='../hw2_data/face/',
